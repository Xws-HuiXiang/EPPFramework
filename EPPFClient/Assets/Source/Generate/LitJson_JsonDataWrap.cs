...
public class LitJson_JsonDataWrap
{
	...
	static int _get_this(IntPtr L)
	{
		try
		{
			...
			{
				LitJson.JsonData obj = (LitJson.JsonData)ToLua.CheckObject<LitJson.JsonData>(L, 1);
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to operator method: LitJson.JsonData.this");
			}
		}
		catch (Exception e)
		{
	...
	static int _set_this(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes<int, LitJson.JsonData>(L, 2))
			{
				LitJson.JsonData obj = (LitJson.JsonData)ToLua.CheckObject<LitJson.JsonData>(L, 1);
				int arg0 = (int)LuaDLL.lua_tonumber(L, 2);
			...
			else if (count == 3 && TypeChecker.CheckTypes<string, LitJson.JsonData>(L, 2))
			{
				LitJson.JsonData obj = (LitJson.JsonData)ToLua.CheckObject<LitJson.JsonData>(L, 1);
				string arg0 = ToLua.ToString(L, 2);
				LitJson.JsonData arg1 = (LitJson.JsonData)ToLua.ToObject(L, 3);
	...
	static int Equals(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<LitJson.JsonData>(L, 2))
			{
				LitJson.JsonData obj = (LitJson.JsonData)ToLua.CheckObject<LitJson.JsonData>(L, 1);
	...
	static int GetValue(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<int>(L, 2))
			{
				LitJson.JsonData obj = (LitJson.JsonData)ToLua.CheckObject<LitJson.JsonData>(L, 1);
				int arg0 = (int)LuaDLL.lua_tonumber(L, 2);
				LitJson.JsonData o = obj.GetValue(arg0);
				ToLua.PushObject(L, o);
				return 1;
			}
			else if (count == 2 && TypeChecker.CheckTypes<string>(L, 2))
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: LitJson.JsonData.GetValue");
			}
		}
		catch (Exception e)
		{
