...
namespace Ciphertext
{
    public class AES
    {
        ...
        public static string AESDecrypt(string DecryptString, string DecryptKey)
        {
            ...
            return Convert.ToBase64String(AESDecrypt(bytes, DecryptKey));
        }
        ...
        /// <returns></returns>
        public static string AESDecryptToString(string DecryptString, string DecryptKey)
        {
            string base64String = AESDecrypt(DecryptString, DecryptKey);
            return Encoding.Default.GetString(Convert.FromBase64String(base64String));
        }

        /// <summary>
        /// AES加密。返回Base64String（主要给lua用）
        /// </summary>
        /// <param name="EncryptString">待加密密文</param>
        /// <param name="EncryptKey">加密密钥</param>
        public static string AESEncryptToString(string EncryptString, string EncryptKey)
        {
